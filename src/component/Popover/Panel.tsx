...
class Panel extends Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        ...
        return this.state.show === true || nextState.show === true
    }
    ...
    render() {
        ...
        this.element.className = classnames(
            popoverClass('_', position, type, parentClose && 'inner'),
        ...
        const provider = { parentClose: this.handleHide, onChildStateChange: this.childStateChange }
