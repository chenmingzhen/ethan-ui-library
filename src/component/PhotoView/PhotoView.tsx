...
export default class PhotoView extends React.Component<IPhotoViewProps, typeof initialState> {
    ...
    onMove = (newClientX: number, newClientY: number, touchLength = 0) => {
        ...
        if ((touched || maskTouched) && isActive) {
            ...
            const offsetX = newClientX - lastMoveClientX
            const offsetY = newClientY - lastMoveClientY
            // 边缘触发状态
    ...
    render() {
        ...
        return (
            <div className={photoViewClass('photo-wrap', viewClassName)} style={style}>
                <div
                    className={photoViewClass('mask')}
                ...
                />
                <div
                    className={photoViewClass('box', {
                        animateIn: loaded && showAnimateType === ShowAnimateEnum.In,
