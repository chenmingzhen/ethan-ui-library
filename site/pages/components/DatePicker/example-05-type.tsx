...
export default function () {
    return (
        <div>
            ...
            <DatePicker.RangePicker type="date" style={style} placeholder={['Select start date', 'Select end date']} />
            ...
            />
            <DatePicker.RangePicker type="week" style={style} placeholder={['start week', 'end week']} />
            <DatePicker.RangePicker type="year" style={style} placeholder={['start year', 'end year']} />
        </div>
    )
}
