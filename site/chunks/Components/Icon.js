...
const examples = [
    ...
    rawText: require('!raw-loader!doc/pages/components/Icon/example-1-awesome.tsx').default,
    },
    {
    name: '2-iconfontx',
    title: locate(
    ...
    // webpack静态资源内联raw-loader, Example中使用，代码内容从此处通过正则筛选
    rawText: require('!raw-loader!doc/pages/components/Icon/example-2-iconfont.tsx').default,
    },
    {
    name: '3-sizex',
    title: locate(
    ...
    // webpack静态资源内联raw-loader, Example中使用，代码内容从此处通过正则筛选
    rawText: require('!raw-loader!doc/pages/components/Icon/example-3-size.tsx').default,
    },
]
